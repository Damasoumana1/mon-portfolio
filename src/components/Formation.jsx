          ...
          >
            <div className="flex items-center mb-8 w-full justify-end">
              <div className="w-5/12 bg-white p-4 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-blue-600">Licence : Informatique programmation et entreprenariat</h3>
                <p className="text-gray-600">Burkina Institute of Technology-BIT</p>
            ...
            <div className="flex items-center mb-8 w-full">
              ...
              <div className="w-5/12 bg-white p-4 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-blue-600">Baccalauréat : Série D</h3>
                <p className="text-gray-600">Lycée Privé Espoir du Faso</p>
