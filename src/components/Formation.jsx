        ...
        <div className="relative">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center mb-8 w-full">
              ...
              <div className="md:w-5/12 w-full p-4 md:p-6 rounded-lg shadow-md break-words whitespace-normal border border-blue-500/20" style={{ backgroundColor: 'var(--bg-secondary)', color: 'var(--text-primary)' }}>
                <h3 className="text-lg md:text-xl font-semibold text-blue-400 mb-2">{getTranslation(language, 'formation.bachelorSchool')}</h3>
                <ul className="list-disc pl-5 text-sm md:text-base space-y-1 mb-3" style={{ color: 'var(--text-secondary)' }}>
                ...
                <div className="text-sm md:text-base mb-3" style={{ color: 'var(--text-secondary)' }}>
                ...
                <p className="text-sm md:text-base font-semibold" style={{ color: 'var(--text-primary)' }}>2022 - 2025</p>
              </div>
            </div>

            {/* Item 2 - High School (left on desktop, stacked on mobile) */}
            <div className="flex flex-col md:flex-row items-center mb-8 w-full">
              <div className="md:w-5/12 w-full p-4 rounded-lg shadow-md order-3 md:order-1 break-words whitespace-normal border border-blue-500/10" style={{ backgroundColor: 'var(--bg-secondary)', color: 'var(--text-primary)' }}>
                <h3 className="text-lg md:text-xl font-semibold text-blue-400">{getTranslation(language, 'formation.degree2')}</h3>
                <p className="text-sm md:text-base" style={{ color: 'var(--text-secondary)' }}>{getTranslation(language, 'formation.school2')}</p>
                <p className="text-sm md:text-base" style={{ color: 'var(--text-secondary)' }}>{getTranslation(language, 'formation.years2')}</p>
              </div>
